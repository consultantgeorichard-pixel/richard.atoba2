...
map.getView().fit([-3917112.384370, -5478976.925123, 12813035.345989, 3733604.180681], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte web de la province de l\'Equateur</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (121 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Une  carte interactive de secteurs d\'activites fictive  dans la province de l\'Equateur et de la superficie par territoire';
            }
